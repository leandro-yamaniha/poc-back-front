"""
Unit tests for repository classes in the Beauty Salon application.
"""
import pytest
...
class TestCustomerRepository:
    ...
    def test_create_customer(self, customer_repo, mock_session):
        ...
        result = customer_repo.create(customer)
        
        assert result == customer
        mock_session.execute.assert_called_once()
    
    def test_get_customer_by_id(self, customer_repo, mock_session):
    ...
    def test_get_customer_by_id_not_found(self, customer_repo, mock_session):
    ...
    def test_get_all_customers(self, customer_repo, mock_session):
        """Test getting all customers."""
        mock_row1 = Mock()
        mock_row1.id = uuid4()
        mock_row1.name = "John Doe"
        mock_row1.email = "john@example.com"
        mock_row1.phone = "+1234567890"
        ...
        result = customer_repo.get_all(limit=10)
    ...
    def test_update_customer(self, customer_repo, mock_session):
        ...
        result = customer_repo.update(customer)
        
        assert result == customer
        mock_session.execute.assert_called_once()
    
    def test_delete_customer(self, customer_repo, mock_session):
        """Test deleting a customer."""
        customer_id = uuid4()
        
        result = customer_repo.delete(customer_id)
...
class TestStaffRepository:
    """Test cases for StaffRepository."""
    ...
    def test_create_staff(self, staff_repo, mock_session):
        ...
        result = staff_repo.create(staff)
        
        assert result == staff
        mock_session.execute.assert_called_once()
    
    def test_get_staff_by_id(self, staff_repo, mock_session):
        ...
        result = staff_repo.get_by_id(staff_id)
...
class TestServiceRepository:
    ...
    def test_create_service(self, service_repo, mock_session):
        ...
        result = service_repo.create(service)
        
        assert result == service
        mock_session.execute.assert_called_once()
    
    def test_get_service_by_id(self, service_repo, mock_session):
        ...
        result = service_repo.get_by_id(service_id)
...
class TestAppointmentRepository:
    ...
    def test_create_appointment(self, appointment_repo, mock_session):
        ...
        result = appointment_repo.create(appointment)
        
        assert result == appointment
        mock_session.execute.assert_called_once()
    
    def test_get_appointment_by_id(self, appointment_repo, mock_session):
        ...
        result = appointment_repo.get_by_id(appointment_id)
